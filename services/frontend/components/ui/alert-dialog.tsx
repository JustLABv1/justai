...
function AlertDialogAction({ className, variant = "default", ...props }: AlertDialogButtonProps) {
  return (
...
function AlertDialogCancel({ className, variant = "outline", ...props }: AlertDialogButtonProps) {
  return (
    <AlertDialogPrimitive.Close
