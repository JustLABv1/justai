...
export function PlatformAdminDashboard({
  ...
  const stats = [
    ...
    [
      "Success rate",
      percentage(summary.succeeded, summary.requests),
      "Completed runs",
    ],
    [
      "Total tokens",
    ...
    [
      "P95 latency",
      summary.p95LatencyMs ? `${Math.round(summary.p95LatencyMs)} ms` : "—",
      "Completed runs",
    ],
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="grid gap-4 xl:grid-cols-[1.15fr_0.85fr]">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Derived from current service health, failures, and platform
              controls.
            </CardDescription>
            <CardAction>
              <Badge
                variant={
                  dashboard.attention.some(
                    ...
                    >
                      ...
                      <span className="min-w-0 flex-1">
                        <span className="flex flex-wrap items-center gap-2">
                          ...
                          <Badge variant={attentionVariant(item.severity)}>
                            {item.severity}
                          </Badge>
                        </span>
          ...
          <CardContent className="grid gap-2 sm:grid-cols-2 xl:grid-cols-1">
            {[
              ...
              [
                "Model endpoints",
                health.providers.ok,
                `${health.providers.enabled} of ${health.providers.total} enabled`,
              ],
              [
                "MCP",
                health.mcp.ok,
                `${health.mcp.enabled} of ${health.mcp.total} enabled`,
              ],
              [
                "Workers",
      ...
      <PlatformTranscriptionWorkers analytics={usage.transcriptionWorkers} />
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Highest request volume in the selected period.
            </CardDescription>
          </CardHeader>
              ...
              >
                <div className="min-w-0">
                  ...
                  <p className="truncate text-xs text-muted-foreground">
                    {item.model || "Model selected at request time"}
                  </p>
                </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Latest platform mutations recorded in the audit trail.
            </CardDescription>
            <CardAction>
              <Button
