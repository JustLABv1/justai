...
import { ConstellationVariant } from "./constellation"
import { ControlRoomVariant } from "./control-room"
import { OrbitVariant } from "./orbit"
import styles from "./prototype.module.css"

const variants: Array<{ name: string; Component: ComponentType }> = [
  { name: "Orbit", Component: OrbitVariant },
  { name: "Constellation", Component: ConstellationVariant },
  { name: "Control Room", Component: ControlRoomVariant },
]
...
export default function TranscriptionPrototype() {
  ...
  const ActiveVariant = variants[current]?.Component ?? OrbitVariant
  ...
  return (
    <div className={styles.stage}>
      ...
      >
        ...
        <button aria-label="Replay animation (R)" className="proto-picker-item proto-picker-replay" onClick={() => setReplayKey((key) => key + 1)} type="button">
          ↻
        </button>
      </nav>
    </div>
