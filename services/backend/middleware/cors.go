...
func CORS(origins []string) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.Header("Access-Control-Allow-Headers", "Authorization, Content-Type, X-Organization-ID, X-CSRF-Token, X-Stream-Token, X-Audio-Batch-Sequence, x-vercel-ai-ui-message-stream")
