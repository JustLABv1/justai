...
func (a *App) Router() *gin.Engine {
	...
	org.DELETE("/knowledge/sources/:id", a.platformFeature("unified_knowledge"), a.deleteKnowledgeSource)
	org.GET("/knowledge/items", a.platformFeature("unified_knowledge"), a.listKnowledgeItems)
	org.GET("/knowledge/items/:id", a.platformFeature("unified_knowledge"), a.getKnowledgeItemDetail)
	org.GET("/knowledge/spaces", a.platformFeature("unified_knowledge"), a.listKnowledgeSpaces)
	org.POST("/knowledge/spaces", a.platformFeature("unified_knowledge"), a.createKnowledgeSpace)
	org.GET("/knowledge/spaces/:id", a.platformFeature("unified_knowledge"), a.getKnowledgeSpace)
	org.PATCH("/knowledge/spaces/:id", a.platformFeature("unified_knowledge"), a.updateKnowledgeSpace)
	org.DELETE("/knowledge/spaces/:id", a.platformFeature("unified_knowledge"), a.deleteKnowledgeSpace)
	// Keep membership mutations outside /knowledge/spaces/:id. Gin treats a
	// wildcard at that prefix as a terminal route and rejects a deeper child
	// such as /spaces/:spaceId/items/:itemId during router construction.
	org.POST("/knowledge/space-items/:spaceId/:itemId", a.platformFeature("unified_knowledge"), a.assignKnowledgeItem)
	org.DELETE("/knowledge/space-items/:spaceId/:itemId", a.platformFeature("unified_knowledge"), a.removeKnowledgeItem)
	org.POST("/knowledge/repositories", a.platformFeature("unified_knowledge"), a.createKnowledgeRepository)
	org.POST("/knowledge/repositories/:id/sync", a.platformFeature("unified_knowledge"), a.syncKnowledgeRepository)
	org.PATCH("/knowledge/repositories/:id/schedule", a.platformFeature("unified_knowledge"), a.updateKnowledgeRepositorySchedule)
	org.PATCH("/knowledge/repositories/:id/config", a.platformFeature("unified_knowledge"), a.updateKnowledgeRepositoryConfig)
	org.GET("/knowledge/repositories/:id/files", a.platformFeature("unified_knowledge"), a.listKnowledgeRepositoryFiles)
	org.DELETE("/knowledge/repositories/:id", a.platformFeature("unified_knowledge"), a.deleteKnowledgeRepository)
	...
	org.GET("/templates", a.listDocumentTemplates)
	org.POST("/templates", a.scopedRateLimit("templates", 20), a.saveDocumentTemplate)
	org.GET("/templates/:id", a.getDocumentTemplate)
	org.GET("/templates/:id/file", a.getDocumentTemplate)
	org.POST("/templates/:id", a.scopedRateLimit("templates", 20), a.saveDocumentTemplate)
	org.DELETE("/templates/:id", a.deleteDocumentTemplate)
	org.GET("/projects", a.listWorkspaceProjects)
	org.POST("/projects", a.createWorkspaceProject)
	org.GET("/projects/:id", a.getWorkspaceProject)
	org.PATCH("/projects/:id", a.updateWorkspaceProject)
	org.DELETE("/projects/:id", a.deleteWorkspaceProject)
	org.GET("/search", a.universalSearch)
	org.GET("/privacy/settings", a.getPrivacySettings)
	org.PUT("/privacy/settings", a.putPrivacySettings)
	org.GET("/privacy/export", a.exportPrivacyData)
