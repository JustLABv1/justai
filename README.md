...
- Chat, voice, and transcription stream server events over resumable SSE. Voice and transcription send sequenced controls and backpressure-bounded audio batches through HTTP uploads protected by separate short-lived upload tokens.
